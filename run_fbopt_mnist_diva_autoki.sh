...
python main_out.py --te_d=0 --tr_d 1 2 --task=mnistcolor10 --bs=16 --aname=diva --trainer=fbopt --nname=conv_bn_pool_2 --epos=2000 --es=1 --mu_init=1e-6 --gamma_y=1.0 --k_i_gain_ratio=0.9
