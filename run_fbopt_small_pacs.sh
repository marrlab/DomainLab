...
python main_out.py --te_d=sketch --tpath=examples/tasks/demo_task_path_list_small.py --bs=16 --aname=jigen --trainer=fbopt --nname=alexnet --epos=200 --es=100 --init_mu=0.01
