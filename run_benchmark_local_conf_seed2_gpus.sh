...
snakemake --rerun-incomplete --resources nvidia_gpu=$NUMBER_GPUS --cores 1 -s "domainlab/exp_protocol/benchmark.smk" --configfile "$CONFIGFILE" --keep-going 2>&1 | tee "$logfile"
