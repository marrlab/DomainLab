...
# Helmholtz
snakemake --profile "examples/yaml/slurm" --latency-wait 60 --keep-going --keep-incomplete --notemp --cores 5 -s "domainlab/exp_protocol/benchmark.smk" --configfile "$CONFIGFILE" 2>&1 | tee "$logfile" 
