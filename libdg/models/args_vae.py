...
def add_args2parser_vae(parser):
    ...
    # FIXME: there should not be default values of hyper-parameters,
    # since otherwise, the user has no idea what they are doing

    # FIXME: all the beta_y should be the same across the algorithms to compare the performance
    parser.add_argument('--gamma_y', type=float, default=7e5,
                        help='multiplier for y classifier')
    parser.add_argument('--gamma_d', type=float, default=1e5,
    ...
    parser.add_argument('--beta_y', type=float, default=1000.,
