...
from domainlab.exp_protocol.aggregate_results import agg_main, agg_results
from domainlab.exp_protocol.run_experiment import apply_dict_to_args, run_experiment


def test_run_experiment():
    utils_run_experiment(
        "examples/benchmark/demo_benchmark.yaml", list_test_domains=["caltech"]
    )
    utils_run_experiment(
        "examples/benchmark/demo_benchmark_mnist4test.yaml", ["0"], no_run=False
    )
