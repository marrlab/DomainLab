...
python main_out.py --te_d=caltech --task=mini_vlcs --bs=8 --aname=diva --trainer=fbopt --nname=alexnet --nname_dom=alexnet --gamma_d=3  --gamma_y=3 --epos=2000 --beta_mu=3 --budget_theta_update_per_mu=20 --init_mu4beta=0.01 --myoptic_pareto
