...
- `--gen` for diva does not effect the training. If this keyword is passed to the command line, then the image generation is started after the training has finished. The generated images are presented below.
