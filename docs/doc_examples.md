...
```
python main_out.py --te_d 0 1 2 --tr_d 3 7 --task=mini_vlcs --aname=diva --nname=conv_bn_pool_2 --nname_dom=conv_bn_pool_2 --gamma_y=7e5 --gamma_d=1e5 --san_check --san_num=8
```
