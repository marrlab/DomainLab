...
def mk_jigen(parent_class=AModelClassif):
    ...
    Details:
        ...
        2. Source images are decomposed into grids of patches, which are then permuted. The task is recovering the original image by predicting the right permutation of the patches.
        The (permuted) input data is first fed into a encoder neural network and then into the two classification networks.
        For more details, see: Carlucci, Fabio M., et al. "Domain generalization by solving jigsaw puzzles." Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition. 2019.
    ...
    Input Parameters: 
        ...
        net_classifier_permutation: neural network, input: output of net_encoder, output: prediction of permutation index
