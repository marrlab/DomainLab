...
from domainlab import g_instance_component_loss_agg
    ...
    class ModelHDUVA(parent_class):
        ...
        def cal_reg_loss(self, tensor_x, tensor_y, tensor_d, others=None):
            ...
            if self.zx_dim > 0:
                ...
                zx_p_minus_q = g_instance_component_loss_agg(p_zx.log_prob(zx_q) - qzx.log_prob(zx_q), 1)
            ...
            zy_p_minus_zy_q = g_instance_component_loss_agg(p_zy.log_prob(zy_q) - qzy.log_prob(zy_q), 1)

            # zd KL diverence
            p_zd = self.net_p_zd(topic_q)
            zd_p_minus_q = g_instance_component_loss_agg(p_zd.log_prob(zd_q) - qzd.log_prob(zd_q), 1)
