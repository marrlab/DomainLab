...
class XYDTEncoderArg(XYDTEncoderElevator):
    ...
    @store_args
    def __init__(self, device, topic_dim, zd_dim, zx_dim, zy_dim, i_c, i_h, i_w, args):
        """
        :param zd_dim:
        :param zx_dim:
        :param zy_dim:
        ...
        net_infer_zx = LSEncoderConvBnReluPool(
            self.zx_dim, self.i_c, self.i_w, self.i_h, conv_stride=1
        )
        ...
        net_infer_zd_topic = EncoderImg2TopicDirZd(
            args=args,
