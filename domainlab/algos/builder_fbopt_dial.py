...
class NodeAlgoBuilderFbOptDial(NodeAlgoBuilder):
    """
    ...
    def init_business(self, exp):
        ...
        trainer_in = TrainerDIAL()
        trainer_in.init_business(model, task, observer, device, args)
        trainer = TrainerFbOpt()
        trainer.init_business(trainer_in, task, observer, device, args)
