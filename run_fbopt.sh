...
python main_out.py --te_d=caltech --task=mini_vlcs --bs=16 --aname=dann --trainer=fbopt --nname=alexnet --epos=20 --beta_mu=3 --budget_theta_update_per_mu=20 --init_mu4beta=0.01
