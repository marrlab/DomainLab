...
python domainlab/utils/generate_fbopt_phase_portrait.py --runs_dir $runs_dir --plot1="lossrd/dyn_beta_d" --plot2="lossrs/setpoint_beta_d" --legend1="KL (-$R_{beta_d}$)" --legend2="setpoint" --output_dir=$OUT_DIR
