...
TODO: command line with the specific arguments used for the paper.

#### Visualization of the results

The results of the experiments are stored in the `runs` directory, generated by Tensorboard.
...
The resulting figures will be stored in the directory `figures_diva`, which can be changed by editing the top of the [script_generate_all_figures_diva.sh](script_generate_all_figures_diva.sh) file if needed.
