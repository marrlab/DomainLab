...
# Folder Task
python main_out.py --te_d=caltech --tpath=examples/task_vlcs.py --debug --bs=2 --nocu

# ImagePath Task
python main_out.py --te_d=sketch --tpath=examples/demo_task_path_list.py --debug --bs=2 --nocu
