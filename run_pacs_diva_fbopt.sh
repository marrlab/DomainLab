...
python main_out.py --te_d=sketch --bs=64 --aname=diva --trainer=fbopt --epos=200 --es=200 --npath_dom=examples/nets/resnet50domainbed.py --tpath=examples/tasks/task_pacs_path_list.py --npath_dom=examples/nets/resnet50domainbed.py --gamma_y=1.0
